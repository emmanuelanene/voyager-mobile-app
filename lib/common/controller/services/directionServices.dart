...
class DirectionServices {
  static Future getDirectionDetailsRider(LatLng pickupLocation, LatLng dropLocation, BuildContext context) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        DirectionModel directionModel = DirectionModel(
          distanceInKM: decodedResponse['routes'][0]['legs'][0]['distance']['text'],
          distanceInMeter: decodedResponse['routes'][0]['legs'][0]['distance']['value'],
          durationInHour: decodedResponse['routes'][0]['legs'][0]['duration']['text'],
          duration: decodedResponse['routes'][0]['legs'][0]['duration']['value'],
          polylinePoints: decodedResponse['routes'][0]['overview_polyline']['points'],
        );
  ...
  static Future getDirectionDetailsDriver(LatLng pickupLocation, LatLng dropLocation, BuildContext context) async {
    final api = Uri.parse(APIs.directionAPI(pickupLocation, dropLocation));
