...
class ProfileDataModel {
  ...
  factory ProfileDataModel.fromMap(Map<String, dynamic> map) {
    return ProfileDataModel(
      ...
      vehicleBrandName:
          map['vehicleBrandName'] != null ? map['vehicleBrandName'] as String : null,
      ...
      vehicleRegistrationNumber:
          map['vehicleRegistrationNumber'] != null ? map['vehicleRegistrationNumber'] as String : null,

      drivingLicenseNumber:
          map['drivingLicenseNumber'] != null ? map['drivingLicenseNumber'] as String : null,

      userType:
          map['userType'] != null ? map['userType'] as String : null,

      registeredDateTime:
          map['registeredDateTime'] != null ? DateTime.fromMillisecondsSinceEpoch(map['registeredDateTime'] as int) : null,

      activeRideRequestID:
          map['activeRideRequestID'] != null ? map['activeRideRequestID'] as String : null,

      driverStatus:
          map['driverStatus'] != null ? map['driverStatus'] as String : null,

      cloudMessagingToken:
          map['cloudMessagingToken'] != null ? map['cloudMessagingToken'] as String : null,
    );
  }
